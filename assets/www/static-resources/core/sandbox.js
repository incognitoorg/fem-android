...
define(function (require) {
		...
		return $.ajax({
		  ...
		  'error': function(ajax, error){
			  ...
			  if(errorCallback){
				  ...
				  errorFallback.call(this, ajax, error);
			  }
			  loader && loader.removeClass('js-loader');
	...
	function errorFallback(response, data){
		console.log('Something bad happened while communicating with back end, you are on your own. Here is what I have for you.' + response);
	}
